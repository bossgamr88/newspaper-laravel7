    ...
    <div class="row" style="margin-top:30px;">
        ...
        <div class="col-md-12" style="border:1px solid #ccc; padding:15px 15px 30px 0px;">
	        ...
	        <div class="col-md-12 image-gallery" style="border:1px solid #ccc; padding:15px 15px 30px 15px; margin-top:30px; margin-bottom:30px;">
    	    	<h3 style="border-bottom:3px solid #81d742; padding-bottom:5px;"><span style="padding:6px 12px; background:#81d742;">HEALTH</span></h3>
        	    <img src="{{url('public/images/basketball-95607_1280-392x272.jpg')}}" /><img src="{{url('public/images/beauty-666605_1920-392x272.jpg')}}" /><img src="{{url('public/images/drone-674238_1280-392x272.jpg')}}" /><img src="{{url('public/images/football-622873_1280-300x205.jpg')}}" /><img src="{{url('public/images/headphones-15600_1280-392x272.jpg')}}" />
	        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12" style="border:1px solid #ccc; padding-bottom:30px;">
                ...
                <h3 style="border-bottom:3px solid #b952c8; padding-bottom:5px;"><span style="padding:6px 12px; background:#b952c8;">FASHION</span></h3>
            		<img src="{{url('public/images/model-600225_1280-390x205.jpg')}}" width="100%" style="margin-bottom:15px;" />
        			<p align="justify">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>Read more <a href="#"><span class="glyphicon glyphicon-chevron-right"></span><span class="glyphicon glyphicon-chevron-right"></span></a>
            	</div>
                <div class="col-md-12" style="border-bottom:1px solid #ccc; padding-bottom:10px; margin-bottom:10px;">
	            	<div class="col-md-4">
                    	<div class="row fashion">
    	            		<img src="{{url('public/images/beauty-666605_1920-392x272.jpg')}}" width="100%" />
        	        	</div>
                    </div>
            	    <div class="col-md-8">
                    	<div class="row">
                ...
                <div class="col-md-12" style="border-bottom:1px solid #ccc; padding-bottom:10px; margin-bottom:10px;">
	            	<div class="col-md-4">
                    	<div class="row fashion">
    	            		<img src="{{url('public/images/window-213496_1280-392x272.jpg')}}" width="100%"/>
        	        	</div>
                    </div>
            	    <div class="col-md-8">
                    	<div class="row">
                ...
                <div class="col-md-12" style="border-bottom:1px solid #ccc; padding-bottom:10px; margin-bottom:10px;">
	            	<div class="col-md-4">
                    	<div class="row fashion">
    	            		<img src="{{url('public/images/relaxed-498245_1280-392x272.jpg')}}" width="100%"/>
        	        	</div>
                    </div>
            	    <div class="col-md-8">
                    	<div class="row">
            ...
            <div class="col-md-12" style="border:1px solid #ccc; padding-bottom:30px;">
                ...
                <h3 style="border-bottom:3px solid #d95757; padding-bottom:5px;"><span style="padding:6px 12px; background:#d95757;">SPORTS</span></h3>
            		<img src="{{url('public/images/relay-race-655353_1280-390x205.jpg')}}" width="100%" style="margin-bottom:15px;" />
        			<p align="justify">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>Read more <a href="#"><span class="glyphicon glyphicon-chevron-right"></span><span class="glyphicon glyphicon-chevron-right"></span></a>
            	</div>
                <div class="col-md-12" style="border-bottom:1px solid #ccc; padding-bottom:10px; margin-bottom:10px;">
	            	<div class="col-md-4">
                    	<div class="row fashion">
    	            		<img src="{{url('public/images/swimmer-583667_1280-392x272.jpg')}}" width="100%"/>
        	        	</div>
                    </div>
            	    <div class="col-md-8">
                ...
                <div class="col-md-12" style="border-bottom:1px solid #ccc; padding-bottom:10px; margin-bottom:10px;">
	            	<div class="col-md-4">
                    	<div class="row fashion">
    	            		<img src="{{url('public/images/basketball-95607_1280-392x272.jpg')}}" width="100%" />
        	        	</div>
                    </div>
            	    <div class="col-md-8">
                    	<div class="row" style="padding-left:0px;">
                ...
                <div class="col-md-12" style="border-bottom:1px solid #ccc; padding-bottom:10px; margin-bottom:10px;">
	            	<div class="col-md-4">
                    	<div class="row fashion">
    	            		<img src="{{url('public/images/football-622873_1280-300x205.jpg')}}" width="100%" />
        	        	</div>
                    </div>
            	    <div class="col-md-8">
                    	<div class="row" style="padding-left:0px;">
                ...
                <div class="col-md-12" style="padding-bottom:10px;">
	            	<div class="col-md-4">
                    	<div class="row fashion">
    	            		<img src="{{url('public/images/relay-race-655353_1280-392x272.jpg')}}" width="100%" />
        	        	</div>
                    </div>
            	    <div class="col-md-8">
                    	<div class="row" style="padding-left:0px;">
        ...
        <div class="col-md-12">
        	...
        	<div class="col-md-6">
            	<img src="{{url('public/images/iphone-500291_1280-390x205.jpg')}}" width="100%" style="margin-bottom:15px;" />
        		<p align="justify">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>Read more <a href="#"><span class="glyphicon glyphicon-chevron-right"></span><span class="glyphicon glyphicon-chevron-right"></span></a>
            </div>
            <div class="col-md-6">
            	<div class="row" style="border-bottom:1px solid #ccc; padding-bottom:10px; margin-bottom:10px;">
	            	<div class="col-md-4">
                    	<div class="row">
    	            		<img src="{{url('public/images/supersonic-fighter-63211_1280-392x272.jpg')}}" width="100%" />
        	        	</div>
                    </div>
            	    <div class="col-md-8">
                ...
                <div class="row" style="border-bottom:1px solid #ccc; padding-bottom:10px; margin-bottom:10px;">
	            	<div class="col-md-4">
                    	<div class="row">
    	            		<img src="{{url('public/images/headphones-15600_1280-392x272.jpg')}}" width="100%" />
        	        	</div>
                    </div>
            	    <div class="col-md-8">
                    	<div class="row" style="padding-left:10px;">
                ...
                <div class="row" style="border-bottom:1px solid #ccc; padding-bottom:10px; margin-bottom:10px;">
	            	<div class="col-md-4">
                    	<div class="row">
    	            		<img src="{{url('public/images/drone-674238_1280-392x272.jpg')}}" width="100%" />
        	        	</div>
                    </div>
            	    <div class="col-md-8">
                    	<div class="row" style="padding-left:10px;">
        ...
        <div class="col-md-12" style="border:1px solid #ccc; padding:15px 15px 30px 15px; margin-top:30px;">
            ...
            <div class="col-md-4">
            	<img src="{{url('public/images/vehicle-193213_1280-800x445.jpg')}}" width="100%" />
            </div>
            <div class="col-md-4">
            	<img src="{{url('public/images/vehicle-193213_1280-800x445.jpg')}}" width="100%" />
            </div>
        ...
        <div class="col-md-12" style="border:1px solid #ccc; padding:15px;">
         ...
         <div class="col-md-12" style="border:1px solid #ccc; padding:15px 15px 7px 15px; margin-top:30px;">
          	<div class="col-md-12" style="border-bottom:1px solid #ccc; padding:0px 10px 20px 10px; margin-bottom:10px;">
            <h3 style="border-bottom:3px solid #2b99ca; padding-bottom:5px;"><span style="padding:6px 12px; background:#2b99ca;">MORE NEWS</span></h3>
            		<img src="{{url('public/images/bride-301814_1280-392x272.jpg')}}" width="100%" style="margin-bottom:15px;" />
        			<p align="justify">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>Read more <a href="#"><span class="glyphicon glyphicon-chevron-right"></span><span class="glyphicon glyphicon-chevron-right"></span></a>
            	</div>
                <div class="col-md-12" style="border-bottom:1px solid #ccc; padding-bottom:10px; margin-bottom:10px;">
	            	<div class="col-md-4">
